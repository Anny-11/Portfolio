      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        >
          ...
          <h2 style={styles.heading}>
            Learning through real-world<br />
            <em style={{ color: '#D4A96A' }}>product exploration.</em>
          </h2>
          <p style={styles.sub}>
            Currently gaining exposure to how early-stage products are researched, validated, and shaped in a startup environment.
          </p>
        </div>
        ...
        <div className="experience-grid">
          {experience.map((item, i) => (
            <ExperienceCard key={item.id} item={item} index={i} onClick={() => setSelectedItem(item)} />
          ))}
        </div>
      </div>
        ...
        <div style={styles.modalOverlay} onClick={() => setSelectedItem(null)}>
          <div style={styles.modalContent} onClick={e => e.stopPropagation()}>
            ...
            <div style={styles.modalBody}>
              ...
              <p style={{...styles.summary, fontSize: '1.05rem', color: '#fff'}}>{selectedItem.modalIntro || selectedItem.summary}</p>
